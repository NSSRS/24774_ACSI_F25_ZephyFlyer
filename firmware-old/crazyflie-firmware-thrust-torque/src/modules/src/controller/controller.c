...
#include "controller_forcetorque.h" // changed
...
static ControllerFcns controllerFunctions[] = {
  ...
  {.init = controllerForceTorqueInit, .test = controllerForceTorqueTest, .update = controllerForceTorque, .name = "ForceTorque"},  // changed
...
void controllerInit(ControllerType controller) {
  ...
  #define CONTROLLER ControllerTypeAutoSelect
  ControllerType forcedController = ControllerTypeAutoSelect;
